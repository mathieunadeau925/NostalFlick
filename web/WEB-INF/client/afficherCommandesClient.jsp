                    ...
                    <div class="columns">
                        <div class="column">
                            <section class="hero is-light">
                                <div class="hero-body">
                                    <h2 class="subtitle">
                                    <fmt:message key="AllOrdersMessage"></fmt:message>${sessionScope.client.prenom}!
                                    </h2>
                                </div>
                            </section>
                            <br>
                            <br>
                        <c:if test="${commandePresente}">
                            <table class="table has-background-white is-fullwidth">
                                <thead>
                                    <tr>
                                        <th class="has-text-left subtitle has-text-dark"><fmt:message key="BuyPageName"></fmt:message>, <fmt:message key="BuyPageFName"></fmt:message></th>
                                        <th class="has-text-left subtitle has-text-dark"><fmt:message key="BuyPageAddress"></fmt:message></th>
                                        <th class="has-text-left subtitle has-text-dark"><fmt:message key="BuyPageCity"></fmt:message></th>
                                        <th class="has-text-right subtitle has-text-dark"><fmt:message key="BuyPagePc"></fmt:message></th>      
                                        </tr>
                                    </thead>
                                    <tr>
                                        <td class="has-text-left subtitle has-text-dark">${sessionScope.client.nom},${sessionScope.client.prenom}</td>
                                    <td class="has-text-left subtitle has-text-dark">${sessionScope.client.adresse}</td>
                                    <td class="has-text-left subtitle has-text-dark">${sessionScope.client.ville}</td>
                                    <td class="has-text-right subtitle has-text-dark">${sessionScope.client.codePostal}</td>      
                                </tr>
                            </table>
                            <table class="table has-background-black is-fullwidth">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="has-text-right subtitle has-text-white"><fmt:message key="OrderPrice"></fmt:message></th>   
                                        </tr>
                                    </thead>
                        ...
                        <c:if test="${!commandePresente}">
                            <section class="hero is-light">
                                <div class="hero-body">
                                    <h2 class="subtitle">
                                        <fmt:message key="NoOrdersMessage"></fmt:message>
                                        </h2>
                                    </div>
                                </section>
                        </c:if>
